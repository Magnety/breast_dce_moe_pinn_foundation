...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Preprocess the Breast-MRI-NACT-Pilot dataset.")
    parser.add_argument("--mode", choices=("plan", "multimodal", "all"), default="all")
    parser.add_argument("--run-id", default="full_v4_breast_mri_nact_pilot")
