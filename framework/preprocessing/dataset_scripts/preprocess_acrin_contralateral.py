...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Preprocess the ACRIN Contralateral Breast MR dataset.")
    parser.add_argument("--mode", choices=("plan", "multimodal", "all"), default="all")
    parser.add_argument("--run-id", default="full_v4_acrin_contralateral")
