...
def main() -> int:
    parser = argparse.ArgumentParser(description="Finetune Breast-DCE-MoE-PINN for masked multi-task prediction.")
    parser.add_argument("--config", default=CONFIG_DIR / "finetune_multitask.yaml")
    ...
    BreastDCEMoEPINNSolver(config, mode="finetune").run()
    return 0
